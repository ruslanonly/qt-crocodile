...
Q_CONSTINIT static const qt_meta_stringdata_CLASSServerENDCLASS_t qt_meta_stringdata_CLASSServerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(17, 0),  // ""
        QT_MOC_LITERAL(18, 11),  // "QTcpSocket*"
        QT_MOC_LITERAL(30, 6),  // "socket"
        QT_MOC_LITERAL(37, 10),  // "newMessage"
        QT_MOC_LITERAL(48, 4),  // "code"
        QT_MOC_LITERAL(53, 7),  // "message"
        QT_MOC_LITERAL(61, 12),  // "disconnected"
        QT_MOC_LITERAL(74, 13),  // "newConnection"
        QT_MOC_LITERAL(88, 18),  // "appendToSocketList"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSServerENDCLASS[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, 0x80000000 | 3, QMetaType::Int, QMetaType::QByteArray,    4,    6,    7,
    QMetaType::Void, 0x80000000 | 3,    4,
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->connected((*reinterpret_cast< std::add_pointer_t<QTcpSocket*>>(_a[1]))); break;
        case 1: _t->newMessage((*reinterpret_cast< std::add_pointer_t<QTcpSocket*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[3]))); break;
        case 2: _t->disconnected((*reinterpret_cast< std::add_pointer_t<QTcpSocket*>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Server::connected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Server::*)(QTcpSocket * , int , QByteArray );
            if (_t _q_method = &Server::newMessage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Server::*)(QTcpSocket * );
            if (_t _q_method = &Server::disconnected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Server::connected(QTcpSocket * _t1)
{
...
// SIGNAL 1
void Server::newMessage(QTcpSocket * _t1, int _t2, QByteArray _t3)
{
...
// SIGNAL 2
void Server::disconnected(QTcpSocket * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
